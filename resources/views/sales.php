...
<body class="g-sidenav-show  bg-gray-200">
    <div class="container-fluid position-relative p-0">
                            ...
                            <div class="card my-4">
                                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div class="bg-gradient-primary shadow-primary border-radius-lg d-flex justify-content-between pt-3 px-4">
                                        <h6 class="text-white text-capitalize pt-1">Sales</h6>
                                    ...
                                    <div class="table-responsive p-5 pt-0">
                                        <table class="table align-items-center mb-0" id="salesTable">
                                            <thead>
                                                ...
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Ordered Quantity</th>
        ...
        <!-- <div class="modal fade" id="addUsersModel" tabindex="-1" aria-labelledby="addUsersModelLabel" aria-hidden="true">
    ...
    <script>
        $(document).ready(function () {
            activeTab('sales');
            DataTableOption.initDataTable('#salesTable', '../../routes/sales_datatable_helper.php');
            let rules = {
                name: {
                    required: true
                },
            ...
            // FormOptions.initValidation('#addUsers', rules);
            // FormOptions.initValidation('#editUsers', rules);
        });
