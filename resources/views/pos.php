...
<body class="">
    ...
    <div class="content-wrapper" style="margin-left: 0px;">
        ...
        #searchResult li:hover,#searchResult li.selected {
            cursor: pointer;
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select id="percentage" class=" form-control " name="percentage"><option value="123">asdasd</option><option value="19">IVA</option></select>
                                </div>
                                                            </div>
                                            </div>
              ...
              <div class="">
                  <form id="formCustomer" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group   ">
                        ...
                        <select id="gender" class="form-control" name="gender"><option value="1">Male</option><option value="2">Female</option><option value="3">Other</option></select>
                                            </div>
                    <div class="form-group  clear">
                    ...
                    <div class="form-group   ">
                        ...
                        <select id="receipt_type" class="form-control" name="receipt_type"><option value="2">Bill to Bill</option><option value="1">Ledger</option></select>
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#total_bill").focus(function() { $(this).select(); } );
            $("#discount").focus(function() { $(this).select(); } );
        });
    </script>
    <script type="text/javascript">
        var i = 0;
        var products = [{"id":2,"product_id":2,"code":{"id":2,"product_id":2,"code":"aas","created_at":"2023-01-17T10:24:21.000000Z","updated_at":"2023-01-17T10:24:21.000000Z","deleted_at":null},"created_at":"2023-01-17T10:24:21.000000Z","updated_at":"2023-02-18T10:50:50.000000Z","deleted_at":null,"name":"elephant","description":"aefad ads das d sad asd sa das d sa sa as das ds a","price":0,"unit":-2.9900000000000002131628207280300557613372802734375,"mrp":10000,"min_mrp":null,"ena":"0.039","alert_quantity":20,"warranty":0,"status":1,"category_id":0,"sub_category_id":0,"imagefile":"8fd67fddfe06d22391f14d90591235f0.jpg","code_text":"aas"},{"id":1,"product_id":1,"code":{"id":1,"product_id":1,"code":"69886","created_at":"2023-01-17T10:09:10.000000Z","updated_at":"2023-01-17T10:09:10.000000Z","deleted_at":null},"created_at":"2023-01-17T10:09:10.000000Z","updated_at":"2023-02-06T20:53:43.000000Z","deleted_at":null,"name":"Muhamassmad Qasim","description":null,"price":100,"unit":-7.95999999999999996447286321199499070644378662109375,"mrp":100,"min_mrp":100,"ena":"1232312","alert_quantity":50,"warranty":0,"status":1,"category_id":0,"sub_category_id":0,"imagefile":"","code_text":"69886"},{"id":4,"product_id":4,"code":{"id":4,"product_id":4,"code":"4","created_at":"2023-02-22T09:41:49.000000Z","updated_at":"2023-02-22T09:41:49.000000Z","deleted_at":null},"created_at":"2023-02-22T09:41:49.000000Z","updated_at":"2023-02-22T09:41:49.000000Z","deleted_at":null,"name":"test","description":null,"price":70,"unit":null,"mrp":70,"min_mrp":70,"ena":null,"alert_quantity":1,"warranty":0,"status":1,"category_id":0,"sub_category_id":0,"imagefile":"bf8fb73bf31741acdeba53428ca9e540.jpg","code_text":"4"},{"id":3,"product_id":3,"code":{"id":3,"product_id":3,"code":"3","created_at":"2023-02-09T02:35:53.000000Z","updated_at":"2023-02-09T02:35:53.000000Z","deleted_at":null},"created_at":"2023-02-09T02:35:53.000000Z","updated_at":"2023-02-09T02:36:07.000000Z","deleted_at":null,"name":"vv","description":null,"price":0.8000000000000000444089209850062616169452667236328125,"unit":0,"mrp":0.8000000000000000444089209850062616169452667236328125,"min_mrp":0.8000000000000000444089209850062616169452667236328125,"ena":null,"alert_quantity":3,"warranty":0,"status":1,"category_id":0,"sub_category_id":0,"imagefile":"","code_text":"3"}];
        var customers = [{"id":1,"name":"vxcbxcb","address":"dvxcvcxv","gender":1,"nid":null,"email":null,"vat_no":null,"opening_balance":null,"due_amount":null,"mobile":"32432432","user_id":1,"receipt_type":2,"status":1,"created_at":"2023-02-05T19:53:22.000000Z","updated_at":"2023-02-05T19:53:22.000000Z","deleted_at":null},{"id":2,"name":"rwerwer","address":"rtewrwer","gender":1,"nid":null,"email":null,"vat_no":null,"opening_balance":null,"due_amount":null,"mobile":"45435345","user_id":1,"receipt_type":2,"status":1,"created_at":"2023-02-06T20:53:21.000000Z","updated_at":"2023-02-06T20:53:21.000000Z","deleted_at":null}];
...
//                            calculatePayment();
        ...
        $('#codenameinput').on('input', function () {
            var company_id = $("#company_id").val(); var filteredProducts = [];
        ...
        function deleteInfo(id, e) {
            ...
            if (confirm("Are you sure to delete it?")) {
                $.ajax({
                    ...
                    method: 'DELETE',
                    type: 'POST',
                    data: {_token: "uPdtEncQmMIRsjyI2cTJaPbOZIYvvMZRJ7RxpPqH"},
...
*/
        function form_validation(e) {
            ...
            } else {$("#customer_id").parent().css('border', '');}
            ...
            } else {$("#percentage").css("border-color", "#e4e7ea");}
                        if ($("#create_date").val() == '' || $("#create_date").val() == null) {
                $("#create_date").css('border-color', 'red');
                decision = false;

            } else {$("#create_date").css("border-color", "#e4e7ea");}
            ...
            if ($(e).val()=='invoice_payment') {
                ...
                } else {$("#total").parent().parent().css('border', '');decision = true;}
                if ($("#discount_amount").val() == '' || $("#discount_amount").val() == null) {
                    $("#discount_amount").parent().parent().css('border', '1px solid red');
                    decision = false;

                } else {$("#discount_amount").parent().parent().css('border', '');decision = true;}
            }
